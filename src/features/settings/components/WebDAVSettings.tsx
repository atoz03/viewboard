...
export const WebDAVSettings = ({
  ...
  return (
    <div className="space-y-3 text-sm">
      <div>
        <label className="vb-muted text-xs">服务器地址</label>
        <input
      ...
      <div>
        <label className="vb-muted text-xs">用户名</label>
        <input
          className="vb-input mt-2"
          value={username}
      ...
      <div>
        <label className="vb-muted text-xs">密码</label>
        <input
          className="vb-input mt-2"
          type="password"
          value={password}
      ...
      <div>
        <label className="vb-muted text-xs">远程目录</label>
        <input
          className="vb-input mt-2"
          value={basePath}
      ...
      <p className="vb-muted-strong text-xs">
